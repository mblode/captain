...
| "restart the captain" / "it died" / "after a rebuild" | `captain restart` (stop-if-running, relaunch with the persisted scope; prints "could not start — check watch.log" rather than lying if the spawn dies instantly)                                                                                                                                               |
